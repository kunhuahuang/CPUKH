 ...
 * Created: 2014-10-2
 * Description: This driver is for LED
...
#define DEVICE_BASE_ADDR	0x41220000
#define DEVICE_REG		1	
...
MODULE_DESCRIPTION("LED driver for Zedboard");
MODULE_LICENSE("GPL");
...
int __init cpukh_init(void)
{
    ...
    if( cpukh_major ) {
        ...
        ret = register_chrdev_region(dev, 1, "led_driver");
    } else {    /*dynamic method*/
    ...
    printk( KERN_NOTICE MODULE_NAME "module led start\n");
...
void __exit cpukh_exit(void)
{
    ...
    printk( KERN_NOTICE MODULE_NAME "module led exit\n");
}
